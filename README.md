...
**[Live Demo →](https://your-app-name.streamlit.app)** &nbsp;|&nbsp; **[Video Walkthrough →](https://youtube.com/your-video-link)**
...
```bash
git clone https://github.com/YOUR-USERNAME/soc-threat-dashboard.git
...
Built by **[Your Name]** — Software Engineering graduate with a focus on cybersecurity and security operations.
